...
template __global__ void scalePower<deviceFFT_t>(deviceFFT_t* __restrict,double,double,int);
template __global__ void scalePower<floatFFT_t>(floatFFT_t* __restrict,double,double,int);