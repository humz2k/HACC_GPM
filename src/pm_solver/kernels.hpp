...
CPUTimer_t launch_combine(float4* d_grad, cufftComplex* d_x, cufftComplex* d_y, cufftComplex* d_z, int numBlocks, int blockSize, int calls);
...
CPUTimer_t launch_kspace_solve_gradient(cufftComplex* d_x, cufftComplex* d_y, cufftComplex* d_z, cufftComplex* d_rho, hostFFT_t* d_greens, int ng, int numBlocks, int blockSize, int calls);
