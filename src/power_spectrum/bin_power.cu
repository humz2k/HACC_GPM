...
__forceinline__ __device__ void calc_power_bins(double* __restrict d_binVals, int* __restrict d_binCounts, double this_val, int idx, int3 idx3d, double minK, double binDelta, double rl, int ng){
